        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid lg:grid-cols-12 gap-x-12 gap-y-8 mb-12">
            <div className="lg:col-span-6">
              ...
              <h2 id="upcoming-title" className="mt-6 text-[clamp(28px,4vw,56px)] font-semibold sm:font-bold display-tight text-neutral-50 text-balance">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid lg:grid-cols-12 gap-x-12 gap-y-8 mb-12">
            <div className="lg:col-span-6">
              ...
              <h2 id="past-title" className="mt-6 text-[clamp(28px,4vw,56px)] font-semibold sm:font-bold display-tight text-neutral-50 text-balance">
                Recent gatherings.
              </h2>
            </div>
            <div className="lg:col-span-6 lg:pl-6 lg:pt-4">
